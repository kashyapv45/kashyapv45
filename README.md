...
Software Engineer with 3+ years of experience designing and delivering scalable **.NET** applications, specializing in ASP.NET Core, microservices, and cloud-native backend systems. I build high-performance RESTful APIs and event-driven architectures on Azure, and currently work on trade settlement infrastructure at **Citigroup**, processing 250K+ transactions daily at 99.99% uptime.

My interests extend into health data analytics, on-device privacy, and AI agent workflows — applying the same distributed-systems discipline to newer problem spaces.
...
### [Sloto](https://github.com/kashyapv45/Sloto)
Production-grade, multi-tenant B2B SaaS engine built on .NET 9, providing a complete architectural foundation for enterprise software with full Native AOT compatibility.
...
### [ai-agent-builder-platform](https://github.com/kashyapv45/ai-agent-builder-platform)
A platform for composing and deploying configurable AI agent workflows.
...
### [ai-mock-interview-app](https://github.com/kashyapv45/ai-mock-interview-app)
An AI-driven mock interview simulator for practicing technical and behavioral interviews.
...
### [kashyapv45.github.io](https://kashyapv45.github.io)
Source for my personal site and portfolio, published via GitHub Pages.
...
[![Email](https://img.shields.io/badge/kashyapvaghani7055%40gmail.com-1C2733?style=flat&logo=gmail&logoColor=4FD1C5)](mailto:kashyap@cvejobs.com)
